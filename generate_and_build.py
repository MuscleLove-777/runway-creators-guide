...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import RunwaySEOOptimizer
        ...
        optimizer = RunwaySEOOptimizer(config)
    ...
    try:
        from site_generator import RunwaySiteGenerator
        site_gen = RunwaySiteGenerator(config)
        site_gen.build_site()
