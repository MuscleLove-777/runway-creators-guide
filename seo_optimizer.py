"""Runway AI動画クリエイターズガイド - SEO最適化ラッパー

blog_engineのSEOOptimizerを使用し、JSON-LD構造化データ生成機能を追加。
BlogPosting / FAQPage / BreadcrumbList / VideoObject に対応。
"""
import json
import sys
import os
...
class RunwaySEOOptimizer(BaseSEOOptimizer):
    """Runway特化のSEO最適化クラス（JSON-LD構造化データ対応）"""
